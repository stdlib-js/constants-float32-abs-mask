...
```javascript
import FLOAT32_ABS_MASK from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-abs-mask@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-abs-mask/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/constants-float32-abs-mask/actions/workflows/test.yml?query=branch:v0.2.2
